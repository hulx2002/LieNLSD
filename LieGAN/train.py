# modified from https://github.com/Rose-STL-Lab/LieGAN/blob/master/train.py
...
def train_lie_gan(
    ...
    for ep in trange(num_epochs):
        ...
        if save_path is not None and (ep + 1) % 10 == 0:
            ...
            torch.save(generator.getLi(), save_path + f'Li_{ep}.pt')
