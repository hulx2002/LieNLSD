...
get_heat_data = partial(gen_data, pde=heat, init_fn=generate_random_ics)
...
if __name__ == '__main__':
    ...
    t, x, u = get_heat_data(n_ics=args.n_ics, L=args.L, n=args.n, n_terms=args.n_terms, dt=args.dt, num_steps=args.num_steps)
    ...
    torch.save(t, f'{args.save_dir}/heat/{args.save_name}-t.pt')
    torch.save(x, f'{args.save_dir}/heat/{args.save_name}-x.pt')
    torch.save(u, f'{args.save_dir}/heat/{args.save_name}-u.pt')
    torch.save(dudx, f'{args.save_dir}/heat/{args.save_name}-dudx.pt')
    torch.save(dudxdx, f'{args.save_dir}/heat/{args.save_name}-dudxdx.pt')
    torch.save(dudt, f'{args.save_dir}/heat/{args.save_name}-dudt.pt')
    torch.save(dudtdx, f'{args.save_dir}/heat/{args.save_name}-dudtdx.pt')