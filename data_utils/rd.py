...
def rd(u, dudxdx, dudydy, v, dvdxdx, dvdydy):
    dudt = (1 - (u ** 2 + v ** 2)) * u + (u ** 2 + v ** 2) * v + 0.1 * (dudxdx + dudydy)
    dvdt = -(u ** 2 + v ** 2) * u + (1 - (u ** 2 + v ** 2)) * v + 0.1 * (dvdxdx + dvdydy)
    return dudt, dvdt
...
get_rd_data = partial(gen_data, pde=rd, init_fn=generate_random_ics)
...
if __name__ == '__main__':
    ...
    t, x, y, u, v = get_rd_data(n_ics=args.n_ics, L=args.L, n=args.n, n_terms=args.n_terms, dt=args.dt, num_steps=args.num_steps)
    ...
    torch.save(t, f'{args.save_dir}/rd/{args.save_name}-t.pt')
    torch.save(x, f'{args.save_dir}/rd/{args.save_name}-x.pt')
    torch.save(y, f'{args.save_dir}/rd/{args.save_name}-y.pt')
    torch.save(u, f'{args.save_dir}/rd/{args.save_name}-u.pt')
    torch.save(dudt, f'{args.save_dir}/rd/{args.save_name}-dudt.pt')
    torch.save(dudx, f'{args.save_dir}/rd/{args.save_name}-dudx.pt')
    torch.save(dudy, f'{args.save_dir}/rd/{args.save_name}-dudy.pt')
    torch.save(dudxdx, f'{args.save_dir}/rd/{args.save_name}-dudxdx.pt')
    torch.save(dudydy, f'{args.save_dir}/rd/{args.save_name}-dudydy.pt')
    torch.save(dudtdx, f'{args.save_dir}/rd/{args.save_name}-dudtdx.pt')
    torch.save(dudtdy, f'{args.save_dir}/rd/{args.save_name}-dudtdy.pt')
    torch.save(dudxdy, f'{args.save_dir}/rd/{args.save_name}-dudxdy.pt')
    torch.save(v, f'{args.save_dir}/rd/{args.save_name}-v.pt')
    torch.save(dvdt, f'{args.save_dir}/rd/{args.save_name}-dvdt.pt')
    torch.save(dvdx, f'{args.save_dir}/rd/{args.save_name}-dvdx.pt')
    torch.save(dvdy, f'{args.save_dir}/rd/{args.save_name}-dvdy.pt')
    torch.save(dvdxdx, f'{args.save_dir}/rd/{args.save_name}-dvdxdx.pt')
    torch.save(dvdydy, f'{args.save_dir}/rd/{args.save_name}-dvdydy.pt')
    torch.save(dvdtdx, f'{args.save_dir}/rd/{args.save_name}-dvdtdx.pt')
    torch.save(dvdtdy, f'{args.save_dir}/rd/{args.save_name}-dvdtdy.pt')
    torch.save(dvdxdy, f'{args.save_dir}/rd/{args.save_name}-dvdxdy.pt')